<template>
  <footer class="flex justify-between mt-4 px-8 py-4 text-gray-500 border-t-2 text-xs font-bold bg-white">
    <div class="plex space-x-4">
      <a href="www.cjsfg.net" class="hover:text-indigo-600">CJSFG</a>
      <!-- <a href="#" class="font-bold hover:text-indigo-600">FAQ</a> -->
      <a href="#" class="font-bold hover:text-indigo-600">Contactez nous</a>
    </div>
    <div>&copy; {{ new Date().getFullYear() }} CJSFG</div>
  </footer>
</template>
